...
func GetConfiguration() Configuration {
	return Configuration{
		...
		DatabasePassword:    getOrDefault("DB_PASSWORD", "20012012"),
		MigrateToVersion:    getOrDefault("MIGRATE", "latest"),
		MigrationLocation:   getOrDefault("MIGRATION_LOCATION", "C:/Users/aleos/Desktop/todo-gr6-go-main/internal/infra/database/migrations"),
